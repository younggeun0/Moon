...
tags: [오라클DBMS]
excerpt: "ORACLE DBMS 정리 - 설계 문서작성, ERD, 테이블설계서, 정규화"
date: 2018-11-12
comments: true
---

## 오라클 DBMS 정리 16 - 설계 문서작성, ERD, 테이블설계서, 정규화 
...
![16-17](https://github.com/younggeun0/younggeun0.github.io/blob/master/_posts/img/oracle/16-17.PNG?raw=true)
